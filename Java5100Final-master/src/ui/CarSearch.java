...
public class CarSearch extends CarSearchDefination implements CarSearchInterface {
	...
	public void setTopPanel() {
		...
		topPanel = new JPanel()
        {
            ...
            {
            	ImageIcon backImage = new ImageIcon("/Java5100Final-master/src/carw.png");
...
/*
        ...
        System.out.println(inventory + "size: " + inventory.getVehicles().size() );
...
*/
        ...
        for (int i = 0; i < length; i++) {
			...
			//carItemPanel.setLayout(new GridBagLayout());
			//GridBagConstraints gbc  = new GridBagConstraints();
            //System.out.println("Finding Image at " + inventory.getVehicles().get(i).getImages());
            //JLabel Picture = new JLabel(new ImageIcon(inventory.getVehicles().get(i).getImages()));
/*
			...
			JLabel bodyTypeLabel = new JLabel("BODY TYPE : "+inventory.getVehicles().get(i).getModel());
